...
<section class="wrapper">
    ...
    try {
        // Tambahkan WHERE clause untuk memfilter data NULL
        $query = "SELECT kode_tujuan, nama_tujuan, pelabuhan_asal 
                 FROM tujuan 
                 WHERE kode_tujuan IS NOT NULL 
                 AND nama_tujuan IS NOT NULL 
                 AND pelabuhan_asal IS NOT NULL 
                 ORDER BY pelabuhan_asal, nama_tujuan";
        ...
        error_log("Jumlah data yang diambil: " . $count);

        while ($row = $result->fetch_assoc()) {
            // Debug untuk melihat data
            error_log("Data Row: " . print_r($row, true));
